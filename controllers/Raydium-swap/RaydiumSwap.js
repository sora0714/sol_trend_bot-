...
class RaydiumSwap {
     ...
     */
    findPoolInfoForTokens(mintA, mintB, liquidityFile) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b;
            ...
            pooldata = [
                ...((_a = liquidityJson === null || liquidityJson === void 0 ? void 0 : liquidityJson.official) !== null && _a !== void 0 ? _a : []),
                ...((_b = liquidityJson === null || liquidityJson === void 0 ? void 0 : liquidityJson.unOfficial) !== null && _b !== void 0 ? _b : []),
            ];
            const poolData = pooldata.find((i) => (i.baseMint === mintA && i.quoteMint === mintB) ||
